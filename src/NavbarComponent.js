...
function NavbarComponent() {
  ...
  return (
    <Navbar className='fixed-top d-flex' bg="dark text-light" expand="lg" style={{padding:'14px'}}>
      <Link to={'/'}>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
          ...
          <button className='btn btn-outline-light stl' style={{marginLeft:'auto', marginRight:'10px'}}>Login</button>
